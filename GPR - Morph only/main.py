...
# --- Features ---
ACTIVE_DESCRIPTORS = ["diameter", "circularity", "compactness"]  # Features to use
INACTIVE_DESCRIPTORS = ["K", "n"]  # Unused features (if any)
...
def main():
    ...
    @use_named_args(space)
    def objective(circularity, compactness):
        weights = {
